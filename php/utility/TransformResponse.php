...
// SpacexRest SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SpacexRestTransformResponse
{
    public static function call(SpacexRestContext $ctx): mixed
    {
        ...
        $transform = SpacexRestHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
