...
class CoreEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CoreEntity($this->_client, $opts);
    }

    /**
     * @param Core|array $args Core data (assoc-array) to store.
     */
    ...
    /**
     * @return Core|array The current Core data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Core fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Core fields).
     */
     ...
     * Load a single Core.
     *
     * @param CoreLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CoreLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Core|array The loaded Core as an assoc-array at the
    ...
    /**
     * List Core items matching the given filter.
     *
     * @param CoreListMatch|array|null $reqmatch Match filter (any subset
     *   of Core fields) as an assoc-array; CoreListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Core[]|array A list of Core items as assoc-arrays at
