...
class LandpadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LandpadEntity($this->_client, $opts);
    }

    /**
     * @param Landpad|array $args Landpad data (assoc-array) to store.
     */
    ...
    /**
     * @return Landpad|array The current Landpad data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Landpad fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Landpad fields).
     */
    ...
    /**
     * Load a single Landpad.
     *
     * @param LandpadLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LandpadLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Landpad|array The loaded Landpad as an assoc-array at the
    ...
    /**
     * List Landpad items matching the given filter.
     *
     * @param LandpadListMatch|array|null $reqmatch Match filter (any subset
     *   of Landpad fields) as an assoc-array; LandpadListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Landpad[]|array A list of Landpad items as assoc-arrays at
