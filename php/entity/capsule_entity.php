...
class CapsuleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CapsuleEntity($this->_client, $opts);
    }

    /**
     * @param Capsule|array $args Capsule data (assoc-array) to store.
     */
    ...
    /**
     * @return Capsule|array The current Capsule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Capsule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Capsule fields).
     */
     ...
     *
     * @param CapsuleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CapsuleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Capsule|array The loaded Capsule as an assoc-array at the
     ...
     *
     * @param CapsuleListMatch|array|null $reqmatch Match filter (any subset
     *   of Capsule fields) as an assoc-array; CapsuleListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Capsule[]|array A list of Capsule items as assoc-arrays at
