...
class LaunchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LaunchEntity($this->_client, $opts);
    }

    /**
     * @param Launch|array $args Launch data (assoc-array) to store.
     */
    ...
    /**
     * @return Launch|array The current Launch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Launch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Launch fields).
     */
    ...
    /**
     * Load a single Launch.
     *
     * @param LaunchLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LaunchLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Launch|array The loaded Launch as an assoc-array at the
    ...
    /**
     * List Launch items matching the given filter.
     *
     * @param LaunchListMatch|array|null $reqmatch Match filter (any subset
     *   of Launch fields) as an assoc-array; LaunchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Launch[]|array A list of Launch items as assoc-arrays at
