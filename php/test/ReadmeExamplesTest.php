...
// SpacexRest SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SpacexRestSDK::test)
...
{
    private const SDK_CLASS = 'SpacexRestSDK';
    ...
    private const SDK_BASE = 'spacexrest_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../spacexrest_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
