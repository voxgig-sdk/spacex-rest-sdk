...
class RoadsterDirectTest extends TestCase
{
    public function test_direct_list_roadster(): void
    {
        $setup = roadster_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-roadster", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
