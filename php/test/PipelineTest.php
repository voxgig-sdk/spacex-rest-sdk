...
{
    private static function utility(): SpacexRestUtility
    {
        return new SpacexRestUtility();
    }
    ...
    private static function ctx(array $over = []): SpacexRestContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SpacexRestContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SpacexRestOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SpacexRestError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SpacexRestOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SpacexRestMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SpacexRestOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SpacexRestMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SpacexRestOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SpacexRestMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SpacexRestSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SpacexRestMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SpacexRestResponse([]),
            'result' => new SpacexRestResult([]),
        ]);
        [, $err] = SpacexRestMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SpacexRestSpec([]),
            'response' => null,
            'result' => new SpacexRestResult([]),
        ]);
        [, $err] = SpacexRestMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SpacexRestSpec(['step' => 's']),
            'response' => new SpacexRestResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SpacexRestResult([]),
        ]);
        [, $err] = SpacexRestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SpacexRestSpec(['step' => 's']),
            'response' => new SpacexRestResponse(self::resp(200, ['v' => 1])),
            'result' => new SpacexRestResult([]),
        ]);
        [, $err] = SpacexRestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SpacexRestSpec(['step' => 's']),
            'response' => new SpacexRestResponse(self::resp(200, ['v' => 2])),
            'result' => new SpacexRestResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SpacexRestMakeResponse::call($ctx);
    ...
    {
        $preset = new SpacexRestResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SpacexRestSpec([]),
            'response' => new SpacexRestResponse([]),
            'result' => new SpacexRestResult([]),
        ...
        [$got, $err] = SpacexRestMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SpacexRestResult([])]);
        [, $err] = SpacexRestMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SpacexRestSpec([]), 'result' => null]);
        [, $err] = SpacexRestMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SpacexRestSpec(['step' => 's']),
            'result' => new SpacexRestResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SpacexRestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SpacexRestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SpacexRestSpec(['step' => 's']),
            'result' => new SpacexRestResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SpacexRestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SpacexRestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SpacexRestResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SpacexRestSpec([]),
            'result' => new SpacexRestResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SpacexRestMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SpacexRestMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SpacexRestError('boom', 'boom');
        $utility->fetcher = function (SpacexRestContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SpacexRestSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SpacexRestMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SpacexRestContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SpacexRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SpacexRestResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SpacexRestMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SpacexRestContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SpacexRestSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SpacexRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SpacexRestResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SpacexRestSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SpacexRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SpacexRestMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SpacexRestMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SpacexRestResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SpacexRestDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SpacexRestResult(['ok' => false])]);
        $this->expectException(SpacexRestError::class);
        SpacexRestDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SpacexRestResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SpacexRestMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SpacexRestMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SpacexRestBaseFeature();
        $b = new SpacexRestBaseFeature();
        SpacexRestFeatureAdd::call($ctx, $a);
        SpacexRestFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SpacexRestBaseFeature
    {
        $f = new SpacexRestBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SpacexRestFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SpacexRestContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SpacexRestSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SpacexRestPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SpacexRestPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SpacexRestResponse(['headers' => null]),
            'result' => new SpacexRestResult([]),
        ]);
        SpacexRestResultHeaders::call($ctx);
