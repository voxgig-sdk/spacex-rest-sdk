...
class LandpadEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SPACEXREST_TEST_LANDPAD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function landpad_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SPACEXREST_TEST_LANDPAD_ENTID");
