...
class RoadsterEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SPACEX_REST_TEST_ROADSTER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function roadster_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SPACEX_REST_TEST_ROADSTER_ENTID");
