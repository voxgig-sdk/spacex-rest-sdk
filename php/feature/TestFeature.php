...
// SpacexRest SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SpacexRestTestFeature extends SpacexRestBaseFeature
{
    ...
    public function init(SpacexRestContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SpacexRestContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = SpacexRestParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SpacexRestContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SpacexRestContext $ctx, $op, $args): array
    {
