...
// SpacexRest SDK ratelimit feature
...
class SpacexRestRatelimitFeature extends SpacexRestBaseFeature
{
    ...
    private function _acquire(SpacexRestContext $ctx): void
    {
    ...
    private function _track(SpacexRestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
