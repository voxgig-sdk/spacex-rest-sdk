...
class CrewEntity extends SpacexRestEntityBase<Crew> {
  ...
  make(this: CrewEntity) {
    return new CrewEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: CrewLoadMatch, ctrl?: Control): Promise<CrewEntity> {
  ...
  async list(this: any, reqmatch?: CrewListMatch, ctrl?: Control): Promise<CrewEntity[]> {
