...
class CoreEntity extends SpacexRestEntityBase<Core> {
  ...
  make(this: CoreEntity) {
    return new CoreEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: CoreLoadMatch, ctrl?: Control): Promise<CoreEntity> {
  ...
  async list(this: any, reqmatch?: CoreListMatch, ctrl?: Control): Promise<CoreEntity[]> {
