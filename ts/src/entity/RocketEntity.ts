...
class RocketEntity extends SpacexRestEntityBase<Rocket> {
  ...
  make(this: RocketEntity) {
    return new RocketEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: RocketLoadMatch, ctrl?: Control): Promise<RocketEntity> {
  ...
  async list(this: any, reqmatch?: RocketListMatch, ctrl?: Control): Promise<RocketEntity[]> {
