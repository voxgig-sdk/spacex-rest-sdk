...
local SDK_MODULE = "spacex-rest_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["capsule"] = { ["test01"] = { id = "test01" } }, ["core"] = { ["test01"] = { id = "test01" } }, ["crew"] = { ["test01"] = { id = "test01" } }, ["landpad"] = { ["test01"] = { id = "test01" } }, ["launch"] = { ["test01"] = { id = "test01" } }, ["launchpad"] = { ["test01"] = { id = "test01" } }, ["payload"] = { ["test01"] = { id = "test01" } }, ["roadster"] = { ["test01"] = { id = "test01" } }, ["rocket"] = { ["test01"] = { id = "test01" } }, ["ship"] = { ["test01"] = { id = "test01" } }, ["starlink"] = { ["test01"] = { id = "test01" } } } }'
