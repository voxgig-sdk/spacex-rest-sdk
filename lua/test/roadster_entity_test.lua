...
describe("RoadsterEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SPACEXREST_TEST_ROADSTER_ENTID JSON to run live")
      return
    end
...
function roadster_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SPACEXREST_TEST_ROADSTER_ENTID")
