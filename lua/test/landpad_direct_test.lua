...
describe("LandpadDirect", function()
  it("should direct-list-landpad", function()
    local setup = landpad_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-landpad", setup.live and "live" or "unit")
  ...
  it("should direct-load-landpad", function()
    local setup = landpad_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-landpad", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function landpad_direct_setup(mockres)
