...
function runner.env_override(m)
  local live = runner.getenv("SPACEX_REST_TEST_LIVE")
  local override = runner.getenv("SPACEX_REST_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SPACEX_REST_TEST_EXPLAIN")
