...
describe("RoadsterDirect", function()
  it("should direct-list-roadster", function()
    local setup = roadster_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-roadster", setup.live and "live" or "unit")
...
function roadster_direct_setup(mockres)
