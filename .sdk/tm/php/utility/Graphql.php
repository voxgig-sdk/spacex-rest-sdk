...
// SpacexRest SDK utility: graphql
//
...
class SpacexRestGraphql
{
    ...
    // equivalent.
    public static function body(SpacexRestContext $ctx): mixed
    {
    ...
    public static function errors(SpacexRestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
