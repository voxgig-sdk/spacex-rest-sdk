...
// SpacexRest SDK utility: fetcher

class SpacexRestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SpacexRestSDK/1.0)';
    ...
    public static function call(SpacexRestContext $ctx, string $fullurl, array $fetchdef): array
    {
