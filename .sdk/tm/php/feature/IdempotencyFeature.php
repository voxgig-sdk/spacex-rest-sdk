...
// SpacexRest SDK idempotency feature
...
class SpacexRestIdempotencyFeature extends SpacexRestBaseFeature
{
    ...
    private function _mutating(SpacexRestContext $ctx): bool
    {
