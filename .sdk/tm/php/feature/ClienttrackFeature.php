...
// SpacexRest SDK clienttrack feature
...
class SpacexRestClienttrackFeature extends SpacexRestBaseFeature
{
    ...
    public function PostConstruct(SpacexRestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SpacexRest-SDK';
