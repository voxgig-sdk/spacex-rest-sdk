...
// SpacexRest SDK streaming feature
...
class SpacexRestStreamingFeature extends SpacexRestBaseFeature
{
    ...
    private function _iterate(SpacexRestResult $result): \Generator
    {
    ...
    private function _streamable(SpacexRestContext $ctx): bool
    {
