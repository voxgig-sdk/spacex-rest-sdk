...
// SpacexRest SDK timeout feature
...
class SpacexRestTimeoutFeature extends SpacexRestBaseFeature
{
    ...
    private function _with_timeout(SpacexRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SpacexRestContext $_ctx, float $ms): void
    {
        $client = $this->client;
