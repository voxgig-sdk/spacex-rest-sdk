...
class SpacexRestCacheFeature extends SpacexRestBaseFeature
{
    ...
    private function _through(SpacexRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
