...
class SpacexRestProxyFeature extends SpacexRestBaseFeature
{
    ...
    public function init(SpacexRestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SpacexRestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
