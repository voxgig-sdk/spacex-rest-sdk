...
class SpacexRestRbacFeature extends SpacexRestBaseFeature
{
    ...
    private function _required(SpacexRestContext $ctx): ?string
    {
    ...
    private function _reject(SpacexRestContext $ctx, string $required): void
    {
    ...
    private function _track(SpacexRestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
