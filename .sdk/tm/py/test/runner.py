...
class SpacexRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SpacexRestTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SpacexRestTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SpacexRestTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
