// Command SpacexRest-mcp is an MCP server exposing the SpacexRest
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SpacexRest_list  — list records of an entity
//	SpacexRest_load  — load a single record of an entity
//
