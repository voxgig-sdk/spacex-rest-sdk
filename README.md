...
This SDK exposes the API as a small set of **semantic entities** — Capsule, Core, Crew, Landpad, Launch, Launchpad, Payload, Roadster, Rocket, Ship and Starlink — that you
