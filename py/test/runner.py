...
class SpacexRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SpacexRestTestRunner.getenv("SPACEXREST_TEST_LIVE")
        override = SpacexRestTestRunner.getenv("SPACEXREST_TEST_OVERRIDE")
        ...
        explain = SpacexRestTestRunner.getenv("SPACEXREST_TEST_EXPLAIN")
