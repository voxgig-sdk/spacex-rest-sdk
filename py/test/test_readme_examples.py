# SpacexRest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SpacexRestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SpacexRestSDK(...) and SpacexRestSDK.test(...) become
#      SpacexRestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "spacexrest_sdk"
_SDK_CLASS = "SpacexRestSDK"
