...
from spacexrest_sdk.utility import register

# Load features
from spacexrest_sdk.feature.base_feature import SpacexRestBaseFeature
from spacexrest_sdk.features import _has_feature, _make_feature
...
class SpacexRestSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "SpacexRestSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SpacexRestSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Landpad(self, data=None) -> "LandpadEntity":
        ...
        from spacexrest_sdk.entity.landpad_entity import LandpadEntity
    ...
    def Launch(self, data=None) -> "LaunchEntity":
        ...
        from spacexrest_sdk.entity.launch_entity import LaunchEntity
    ...
    def Launchpad(self, data=None) -> "LaunchpadEntity":
        ...
        from spacexrest_sdk.entity.launchpad_entity import LaunchpadEntity
    ...
    def Payload(self, data=None) -> "PayloadEntity":
        ...
        from spacexrest_sdk.entity.payload_entity import PayloadEntity
    ...
    def Roadster(self, data=None) -> "RoadsterEntity":
        ...
        from spacexrest_sdk.entity.roadster_entity import RoadsterEntity
    ...
    def Rocket(self, data=None) -> "RocketEntity":
        ...
        from spacexrest_sdk.entity.rocket_entity import RocketEntity
        return RocketEntity(self, data)


    def Ship(self, data=None) -> "ShipEntity":
        """Entity factory: client.Ship().list() / client.Ship().load({"id": ...})."""
        from spacexrest_sdk.entity.ship_entity import ShipEntity
    ...
    def Starlink(self, data=None) -> "StarlinkEntity":
        ...
        from spacexrest_sdk.entity.starlink_entity import StarlinkEntity
