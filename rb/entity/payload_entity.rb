...
class PayloadEntity
  ...
  def make
    opts = @_entopts.dup
    PayloadEntity.new(@_client, opts)
  end
  ...
  # @return [Payload, Hash] the current Payload data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Payload fields)
  def match_get
  ...
  #
  # @param reqmatch [PayloadLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Payload.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payload, Hash] the loaded Payload; raises SpacexRestError on failure
  ...
  #
  # @param reqmatch [PayloadListMatch, Hash, nil] match filter (any subset of
  #   Payload fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Payload>, Array] the matching Payload items; raises SpacexRestError on failure
