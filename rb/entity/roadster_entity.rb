...
class RoadsterEntity
  ...
  def make
    opts = @_entopts.dup
    RoadsterEntity.new(@_client, opts)
  end
  ...
  # @return [Roadster, Hash] the current Roadster data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Roadster fields)
  def match_get
  ...
  #
  # @param reqmatch [RoadsterListMatch, Hash, nil] match filter (any subset of
  #   Roadster fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Roadster>, Array] the matching Roadster items; raises SpacexRestError on failure
