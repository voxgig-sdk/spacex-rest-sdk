...
class ShipEntity
  ...
  # @return [Ship, Hash] the current Ship data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Ship fields)
  def match_get
  ...
  # Load a single Ship.
  #
  # @param reqmatch [ShipLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Ship.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Ship, Hash] the loaded Ship; raises SpacexRestError on failure
  ...
  #
  # @param reqmatch [ShipListMatch, Hash, nil] match filter (any subset of
  #   Ship fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Ship>, Array] the matching Ship items; raises SpacexRestError on failure
