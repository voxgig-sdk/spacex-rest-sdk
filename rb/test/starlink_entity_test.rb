...
class StarlinkEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set SPACEXREST_TEST_STARLINK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def starlink_basic_setup(extra)
  ...
  entid_env_raw = ENV["SPACEXREST_TEST_STARLINK_ENTID"]
