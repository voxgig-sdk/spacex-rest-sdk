...
class LandpadEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    landpad_ref01_list_result, err = landpad_ref01_ent.list(landpad_ref01_match, nil)
    assert_nil err
    ...
    landpad_ref01_data_dt0_loaded, err = landpad_ref01_ent.load(landpad_ref01_match_dt0, nil)
    assert_nil err
