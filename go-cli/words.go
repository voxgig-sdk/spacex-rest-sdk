...
func registerSDKWords(r *eng.Registry, client *sdk.SpacexRestSDK) {
...
func runOp(client *sdk.SpacexRestSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
