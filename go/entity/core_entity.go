...
func NewCoreEntity(client *core.SpacexRestSDK, entopts map[string]any) *CoreEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CoreEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CoreEntity) Deleted() bool {
	return e.deleted
}


func (e *CoreEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCoreEntity(e.client, opts)
}

func (e *CoreEntity) Data(args ...any) any {
...
func (e *CoreEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Core; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CoreEntity) DataTyped(data ...Core) Core {
	if len(data) > 0 {
		return typedFrom[Core](e.Data(asMap(data[0])))
	}
	return typedFrom[Core](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Core (all fields
// optional at the wire level).
func (e *CoreEntity) MatchTyped(match ...Core) Core {
	if len(match) > 0 {
		return typedFrom[Core](e.Match(asMap(match[0])))
	}
	return typedFrom[Core](e.Match())
}
...
func (e *CoreEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CoreEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CoreLoadMatch and returns an Core. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CoreEntity) LoadTyped(reqmatch CoreLoadMatch, ctrl map[string]any) (Core, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Core{}, err
	}
	return typedFrom[Core](res), nil
}




func (e *CoreEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CoreListMatch and returns []Core. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CoreEntity) ListTyped(reqmatch CoreListMatch, ctrl map[string]any) ([]Core, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Core](res), nil
}



func (e *CoreEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CoreEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CoreEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CoreEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
