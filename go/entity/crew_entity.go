...
func NewCrewEntity(client *core.SpacexRestSDK, entopts map[string]any) *CrewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CrewEntity) GetName() string { return e.name }
...
func (e *CrewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CrewEntity) Deleted() bool {
	return e.deleted
}


func (e *CrewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCrewEntity(e.client, opts)
}

func (e *CrewEntity) Data(args ...any) any {
...
func (e *CrewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CrewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CrewEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CrewLoadMatch and returns an Crew. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CrewEntity) LoadTyped(reqmatch CrewLoadMatch, ctrl map[string]any) (Crew, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Crew{}, err
	}
	return typedFrom[Crew](res), nil
}




func (e *CrewEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *CrewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CrewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CrewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CrewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
