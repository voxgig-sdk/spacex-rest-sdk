...
func NewRoadsterEntity(client *core.SpacexRestSDK, entopts map[string]any) *RoadsterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RoadsterEntity) GetName() string { return e.name }
...
func (e *RoadsterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RoadsterEntity) Deleted() bool {
	return e.deleted
}


func (e *RoadsterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRoadsterEntity(e.client, opts)
}

func (e *RoadsterEntity) Data(args ...any) any {
...
func (e *RoadsterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Roadster; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RoadsterEntity) DataTyped(data ...Roadster) Roadster {
	if len(data) > 0 {
		return typedFrom[Roadster](e.Data(asMap(data[0])))
	}
	return typedFrom[Roadster](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Roadster (all fields
// optional at the wire level).
func (e *RoadsterEntity) MatchTyped(match ...Roadster) Roadster {
	if len(match) > 0 {
		return typedFrom[Roadster](e.Match(asMap(match[0])))
	}
	return typedFrom[Roadster](e.Match())
}
...
func (e *RoadsterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RoadsterEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RoadsterEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RoadsterListMatch and returns []Roadster. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RoadsterEntity) ListTyped(reqmatch RoadsterListMatch, ctrl map[string]any) ([]Roadster, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Roadster](res), nil
}



func (e *RoadsterEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RoadsterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RoadsterEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RoadsterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
