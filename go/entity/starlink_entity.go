...
func NewStarlinkEntity(client *core.SpacexRestSDK, entopts map[string]any) *StarlinkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StarlinkEntity) GetName() string { return e.name }
...
func (e *StarlinkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StarlinkEntity) Deleted() bool {
	return e.deleted
}


func (e *StarlinkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStarlinkEntity(e.client, opts)
}

func (e *StarlinkEntity) Data(args ...any) any {
...
func (e *StarlinkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Starlink; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StarlinkEntity) DataTyped(data ...Starlink) Starlink {
	if len(data) > 0 {
		return typedFrom[Starlink](e.Data(asMap(data[0])))
	}
	return typedFrom[Starlink](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Starlink (all fields
// optional at the wire level).
func (e *StarlinkEntity) MatchTyped(match ...Starlink) Starlink {
	if len(match) > 0 {
		return typedFrom[Starlink](e.Match(asMap(match[0])))
	}
	return typedFrom[Starlink](e.Match())
}
...
func (e *StarlinkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StarlinkEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StarlinkLoadMatch and returns an Starlink. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StarlinkEntity) LoadTyped(reqmatch StarlinkLoadMatch, ctrl map[string]any) (Starlink, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Starlink{}, err
	}
	return typedFrom[Starlink](res), nil
}




func (e *StarlinkEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// StarlinkListMatch and returns []Starlink. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StarlinkEntity) ListTyped(reqmatch StarlinkListMatch, ctrl map[string]any) ([]Starlink, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Starlink](res), nil
}



func (e *StarlinkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StarlinkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StarlinkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StarlinkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
