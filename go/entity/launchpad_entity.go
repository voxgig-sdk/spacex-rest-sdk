...
func NewLaunchpadEntity(client *core.SpacexRestSDK, entopts map[string]any) *LaunchpadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LaunchpadEntity) GetName() string { return e.name }
...
func (e *LaunchpadEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LaunchpadEntity) Deleted() bool {
	return e.deleted
}


func (e *LaunchpadEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLaunchpadEntity(e.client, opts)
}

func (e *LaunchpadEntity) Data(args ...any) any {
...
func (e *LaunchpadEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Launchpad; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LaunchpadEntity) DataTyped(data ...Launchpad) Launchpad {
	if len(data) > 0 {
		return typedFrom[Launchpad](e.Data(asMap(data[0])))
	}
	return typedFrom[Launchpad](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Launchpad (all fields
// optional at the wire level).
func (e *LaunchpadEntity) MatchTyped(match ...Launchpad) Launchpad {
	if len(match) > 0 {
		return typedFrom[Launchpad](e.Match(asMap(match[0])))
	}
	return typedFrom[Launchpad](e.Match())
}
...
func (e *LaunchpadEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LaunchpadEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LaunchpadLoadMatch and returns an Launchpad. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LaunchpadEntity) LoadTyped(reqmatch LaunchpadLoadMatch, ctrl map[string]any) (Launchpad, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Launchpad{}, err
	}
	return typedFrom[Launchpad](res), nil
}




func (e *LaunchpadEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// LaunchpadListMatch and returns []Launchpad. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LaunchpadEntity) ListTyped(reqmatch LaunchpadListMatch, ctrl map[string]any) ([]Launchpad, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Launchpad](res), nil
}



func (e *LaunchpadEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LaunchpadEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LaunchpadEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LaunchpadEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
