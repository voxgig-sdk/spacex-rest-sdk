...
func NewPayloadEntity(client *core.SpacexRestSDK, entopts map[string]any) *PayloadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PayloadEntity) GetName() string { return e.name }
...
func (e *PayloadEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PayloadEntity) Deleted() bool {
	return e.deleted
}


func (e *PayloadEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPayloadEntity(e.client, opts)
}

func (e *PayloadEntity) Data(args ...any) any {
...
func (e *PayloadEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PayloadEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PayloadEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *PayloadEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PayloadEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PayloadEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PayloadEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
