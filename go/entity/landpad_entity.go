...
func NewLandpadEntity(client *core.SpacexRestSDK, entopts map[string]any) *LandpadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LandpadEntity) GetName() string { return e.name }
...
func (e *LandpadEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LandpadEntity) Deleted() bool {
	return e.deleted
}


func (e *LandpadEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLandpadEntity(e.client, opts)
}

func (e *LandpadEntity) Data(args ...any) any {
...
func (e *LandpadEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Landpad; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LandpadEntity) DataTyped(data ...Landpad) Landpad {
	if len(data) > 0 {
		return typedFrom[Landpad](e.Data(asMap(data[0])))
	}
	return typedFrom[Landpad](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Landpad (all fields
// optional at the wire level).
func (e *LandpadEntity) MatchTyped(match ...Landpad) Landpad {
	if len(match) > 0 {
		return typedFrom[Landpad](e.Match(asMap(match[0])))
	}
	return typedFrom[Landpad](e.Match())
}
...
func (e *LandpadEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LandpadEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LandpadLoadMatch and returns an Landpad. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LandpadEntity) LoadTyped(reqmatch LandpadLoadMatch, ctrl map[string]any) (Landpad, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Landpad{}, err
	}
	return typedFrom[Landpad](res), nil
}




func (e *LandpadEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// LandpadListMatch and returns []Landpad. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LandpadEntity) ListTyped(reqmatch LandpadListMatch, ctrl map[string]any) ([]Landpad, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Landpad](res), nil
}



func (e *LandpadEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LandpadEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LandpadEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LandpadEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
