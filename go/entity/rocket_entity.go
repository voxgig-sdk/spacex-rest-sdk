...
func NewRocketEntity(client *core.SpacexRestSDK, entopts map[string]any) *RocketEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RocketEntity) GetName() string { return e.name }
...
func (e *RocketEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RocketEntity) Deleted() bool {
	return e.deleted
}


func (e *RocketEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRocketEntity(e.client, opts)
}

func (e *RocketEntity) Data(args ...any) any {
...
func (e *RocketEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rocket; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RocketEntity) DataTyped(data ...Rocket) Rocket {
	if len(data) > 0 {
		return typedFrom[Rocket](e.Data(asMap(data[0])))
	}
	return typedFrom[Rocket](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rocket (all fields
// optional at the wire level).
func (e *RocketEntity) MatchTyped(match ...Rocket) Rocket {
	if len(match) > 0 {
		return typedFrom[Rocket](e.Match(asMap(match[0])))
	}
	return typedFrom[Rocket](e.Match())
}
...
func (e *RocketEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RocketEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RocketLoadMatch and returns an Rocket. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RocketEntity) LoadTyped(reqmatch RocketLoadMatch, ctrl map[string]any) (Rocket, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Rocket{}, err
	}
	return typedFrom[Rocket](res), nil
}




func (e *RocketEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RocketListMatch and returns []Rocket. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RocketEntity) ListTyped(reqmatch RocketListMatch, ctrl map[string]any) ([]Rocket, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Rocket](res), nil
}



func (e *RocketEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RocketEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RocketEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RocketEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
