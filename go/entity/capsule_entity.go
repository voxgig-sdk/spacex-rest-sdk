...
func NewCapsuleEntity(client *core.SpacexRestSDK, entopts map[string]any) *CapsuleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CapsuleEntity) GetName() string { return e.name }
...
func (e *CapsuleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CapsuleEntity) Deleted() bool {
	return e.deleted
}


func (e *CapsuleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCapsuleEntity(e.client, opts)
}

func (e *CapsuleEntity) Data(args ...any) any {
...
func (e *CapsuleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Capsule; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CapsuleEntity) DataTyped(data ...Capsule) Capsule {
	if len(data) > 0 {
		return typedFrom[Capsule](e.Data(asMap(data[0])))
	}
	return typedFrom[Capsule](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Capsule (all fields
// optional at the wire level).
func (e *CapsuleEntity) MatchTyped(match ...Capsule) Capsule {
	if len(match) > 0 {
		return typedFrom[Capsule](e.Match(asMap(match[0])))
	}
	return typedFrom[Capsule](e.Match())
}
...
func (e *CapsuleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CapsuleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CapsuleLoadMatch and returns an Capsule. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CapsuleEntity) LoadTyped(reqmatch CapsuleLoadMatch, ctrl map[string]any) (Capsule, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Capsule{}, err
	}
	return typedFrom[Capsule](res), nil
}




func (e *CapsuleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CapsuleListMatch and returns []Capsule. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CapsuleEntity) ListTyped(reqmatch CapsuleListMatch, ctrl map[string]any) ([]Capsule, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Capsule](res), nil
}



func (e *CapsuleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CapsuleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CapsuleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CapsuleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
