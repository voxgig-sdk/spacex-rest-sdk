...
func NewLaunchEntity(client *core.SpacexRestSDK, entopts map[string]any) *LaunchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LaunchEntity) GetName() string { return e.name }
...
func (e *LaunchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LaunchEntity) Deleted() bool {
	return e.deleted
}


func (e *LaunchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLaunchEntity(e.client, opts)
}

func (e *LaunchEntity) Data(args ...any) any {
...
func (e *LaunchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Launch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LaunchEntity) DataTyped(data ...Launch) Launch {
	if len(data) > 0 {
		return typedFrom[Launch](e.Data(asMap(data[0])))
	}
	return typedFrom[Launch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Launch (all fields
// optional at the wire level).
func (e *LaunchEntity) MatchTyped(match ...Launch) Launch {
	if len(match) > 0 {
		return typedFrom[Launch](e.Match(asMap(match[0])))
	}
	return typedFrom[Launch](e.Match())
}
...
func (e *LaunchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LaunchEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LaunchLoadMatch and returns an Launch. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LaunchEntity) LoadTyped(reqmatch LaunchLoadMatch, ctrl map[string]any) (Launch, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Launch{}, err
	}
	return typedFrom[Launch](res), nil
}




func (e *LaunchEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// LaunchListMatch and returns []Launch. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LaunchEntity) ListTyped(reqmatch LaunchListMatch, ctrl map[string]any) ([]Launch, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Launch](res), nil
}



func (e *LaunchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LaunchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LaunchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LaunchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
