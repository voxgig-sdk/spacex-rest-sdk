...
func (sdk *SpacexRestSDK) OptionsMap() map[string]any {
...
func (sdk *SpacexRestSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *SpacexRestSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *SpacexRestSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SpacexRestSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *SpacexRestSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *SpacexRestSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("SpacexRestSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *SpacexRestSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SpacexRestSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("SpacexRestSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
