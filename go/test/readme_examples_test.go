...
const testSeed = `map[string]any{"entity": map[string]any{"capsule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "core": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "crew": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "landpad": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "launch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "launchpad": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payload": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "roadster": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rocket": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ship": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "starlink": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
