...
// instead of `sdk.NewSpacexRestSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *SpacexRestSDK  { return NewSpacexRestSDK(nil) }
func Test() *SpacexRestSDK { return TestSDK(nil, nil) }
