...
The Golang SDK for the SpacexRest API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/spacex-rest-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/spacex-rest-sdk=../path/to/github.com/voxgig-sdk/spacex-rest-sdk
```
...
```
github.com/voxgig-sdk/spacex-rest-sdk/
...
The root package (`github.com/voxgig-sdk/spacex-rest-sdk`) re-exports everything needed
